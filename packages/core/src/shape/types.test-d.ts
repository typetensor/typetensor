...
describe('Basic Shape Types', () => {
  ...
  it('should define common shape patterns', () => {
...
describe('Shape Arithmetic', () => {
  it('should calculate product of shape dimensions', () => {
  ...
  it('should handle permutations and transpositions', () => {
  ...
  it('should handle squeeze and unsqueeze', () => {
...
describe('Shape Validation', () => {
  ...
  it('should validate matrix multiplication compatibility', () => {
  ...
  it('should compute matrix multiplication result shapes', () => {
    ...
    expectTypeOf<MatMulShape<[1, 32, 2, 3], [1, 32, 3, 4]>>().toEqualTypeOf<
      readonly [1, 32, 2, 4]
    >();
...
describe('Error Types', () => {
  it('should create shape error types', () => {
  ...
  it('should create shape mismatch errors', () => {
  ...
  it('should create incompatible shapes type', () => {
...
describe('Utility Types', () => {
  it('should create tuples of identical values', () => {
...
describe('Complex Type Integration', () => {
  it('should handle neural network layer shape inference', () => {
  ...
  it('should handle convolution shape inference', () => {
  ...
  it('should handle broadcasting in neural networks', () => {
  ...
  it('should validate tensor operation chains', () => {
...
describe('Edge Cases', () => {
  it('should handle empty and scalar shapes', () => {
    // Scalar (empty shape)
    expectTypeOf<Product<[]>>().toEqualTypeOf<1>();
    expectTypeOf<Length<[]>>().toEqualTypeOf<0>();
    expectTypeOf<IsEmpty<[]>>().toEqualTypeOf<true>();
  ...
  it('should handle transpose edge cases', () => {
  ...
  it('should handle squeeze/unsqueeze edge cases', () => {
  ...
  it('should handle maximum rank constraints', () => {
...
describe('Performance Boundaries', () => {
  it('should handle reasonably complex operations without hanging', () => {
  ...
  it('should handle large product calculations', () => {
  ...
  it('should handle deep permutations at max rank', () => {
  ...
  it('should handle array access edge cases', () => {
  ...
  it('should work with common ML shape patterns', () => {
    // Common CNN shapes
...
describe('Type Function Composition', () => {
  it('should compose shape transformations', () => {
  ...
  it('should compose with broadcasting', () => {
